...
const forms = state => {
  const formsCollection = document.querySelectorAll('form'),
        ...
        windowsCollection = document.querySelectorAll('[data-modal]'); // checkNumInputs('input[name="user_phone"]');
...
const modals = () => {
  ...
  function showModalByTime(selector, time) {
    setTimeout(() => {
      let display; // check if any modal is open
      ...
      if (!display) {
        ...
        document.body.style.overflow = "hidden"; // scroll width is fixed
